...
extract($_REQUEST);
	if(isset($btn))
	{
		$q1=mysqli_query($connect,"select * from ph_register where uname='$uname' && pass='$pass' ");
			$n1=mysqli_num_rows($q1);
				...
				{
				header("location:cus_login.php?act=wrong");
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                         <img src="images/cus.jpg" class="img-responsive" alt="">
                    </div>
