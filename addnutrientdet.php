...
if(isset($btn))
{
$mq=mysqli_query($connect, "select max(id) from nutrition_details");
$mr=mysqli_fetch_array($mq);
$id=$mr['max(id)']+1;

$rdate=date("d-m-Y");
$ins=mysqli_query($connect, "insert into nutrition_details(id,apid,patient,doctor,title,content,meal_plan,rdate) values($id,'$apid','$patient','$uname','$title','$content','$meal_plan','$rdate')");
if($ins)
{
...
<br><br><br>
<center>
<h2>Nutrition Details for Pregnant Women</h2>

</center>
<h3 align="center">Patient Name: <?php echo $patient; ?></h3>
<p align="center">&nbsp;</p>
<div class="my">
