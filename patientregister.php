...
$rdate=date("d-m-Y");
 if(isset($btn))
 {
 $mq=mysqli_query($connect,"select max(id) from patient");
	 $mr=mysqli_fetch_array($mq);
	 $id=$mr['max(id)']+1;
	 		
	 $ins=mysqli_query($connect,"insert into patient(id,hname,name,husname,fname,mname,gender,dob,address,city,contact,contact1,contact2,email,blood_grp,disease,doctor,status,uname,pass,rdate) values($id,'$hname','$name','$husname','$fname','$mname','$gender','$dob','$address','$city','$mobile','$mobile1','$mobile2','$email','$blood_grp','','','','$uname','$pass','$rdate')");
echo "insert into patient(id,hname,name,husname,fname,mname,gender,dob,address,city,contact,contact1,contact2,email,blood_grp,disease,doctor,status,uname,pass,rdate) values($id,'$hname','$name','$husname','$fname','$mname','$gender','$dob','$address','$city','$mobile','$mobile1','$mobile2','$email','$blood_grp','','','','$uname','$pass','$rdate'";
 		if($ins)
		{
		?>
	<script language="javascript">
	window.location.href="patientregister.php?act=success";
	</script>
	<?php
...
function validate()
{
	...
	{
	document.getElementById("x101").style.display="block";
	return false;
	}
	else
	{
	...
	{
	document.getElementById("x103").style.display="block";
	return false;
	}
	else
	{
	...
	{
	document.getElementById("x500").style.display="block";
	return false;
	}
	else
	{
	document.getElementById("x500").style.display="none";
	}
    
    if(document.form1.blood_grp.value=="")
	{
	document.getElementById("x104").style.display="block";
	return false;
	}
	else
	{
          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                         ...
                         <li><a href="patientlogin.php" class="smoothScroll">Patient</a></li>
               ...
               <div class="row">
                  ...
                  <div class="wow fadeInUp" data-wow-delay="0.8s">
                                     <div class="col-md-6 col-sm-6">
                                        ...
                                        <select name="hname" id="hname" class="form-control">
                                        <option value="">--Choose Hospital--</option>
                                        <?php
                                        $mq1=mysqli_query($connect,"select * from ph_branch");
                                        while($mr1=mysqli_fetch_array($mq1)){
                                            ?>
                                            <option value="<?php echo $mr1['branch'];?>"><?php echo $mr1['branch'];?></option>
                                            <?php
                                        }

                                        ?>
                                        </select>
										<span id="x7" class="msg"  style="display:none">Select Hospital</span>
                                   </div>
                                   ...
                                   <div class="col-md-6 col-sm-6">
                                        ...
                                        <input type="text" class="form-control" id="husname" name="husname" placeholder="Husband Name">
                                   </div>
                                   <div class="col-md-6 col-sm-6">
                                        <label for="name">Father Name</label>
                                        <input type="text" class="form-control" id="fname" name="fname" placeholder="Father Name">
										<span id="x100" class="msg"  style="display:none">Enter the Father Name</span>
                                   </div>
                                   <div class="col-md-6 col-sm-6">
                                        <label for="name">Mother Name</label>
                                        <input type="text" class="form-control" id="mname" name="mname" placeholder="Mother Name">
										<span id="x101" class="msg"  style="display:none">Enter the Mother Name</span>
                                   </div>
                                   <div class="col-md-6 col-sm-6">
                                        <label for="name">DOB</label>
                                        <input type="date" class="form-control" id="dob" name="dob" placeholder="Mother Name">
										<span id="x500" class="msg"  style="display:none">Enter Dob</span>
                                   </div>
                                   ...
                                   <div class="col-md-6 col-sm-6">
										...
										<span id="x103" class="msg"  style="display:none">Select Gender</span>
                                   </div>
						  ...
						  <span id="x52" class="msg"  style="display:none">Mobile no. must be 10 digits!</span>
                                   ...
                                   <div class="col-md-6 col-sm-6">
                                        <label for="date">Relative Mobile No. 1.</label>
                                        <input type="text" name="mobile1" value="" class="form-control" placeholder="Your Mobile No.">
										
                                   </div>
                                   <div class="col-md-6 col-sm-6">
                                        <label for="date">Relative Mobile No. 2.</label>
                                        <input type="text" name="mobile2" value="" class="form-control" placeholder="Your Mobile No.">
                                   ...
                                   <div class="col-md-6 col-sm-6">
										...
										<span id="x104" class="msg"  style="display:none">Select Blood Group</span>
                                   </div>
