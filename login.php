...
extract($_REQUEST);
	if(isset($btn))
	{
		$q1=mysqli_query($connect,"select * from ph_doctor_register where uname='$uname' && pass='$pass' ");
			$n1=mysqli_num_rows($q1);
				if($n1==1)
				{
				$_SESSION['uname']=$uname;
				header("location:view_br.php");
				}
				else
				{
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                         <img src="images/slider33.jpg" class="img-responsive" alt="">
                    </div>
                    ...
                    <div class="col-md-6 col-sm-6">
                         ...
                         <form name="form1" id="appointment-form" role="form" method="post" action="">
                              ...
                              <div class="wow fadeInUp" data-wow-delay="0.8s">
								   ...
								   <a href="Doctor_register.php" class="smoothScroll"> New Doctor Registration</a>
								    <?php
