...
$rdate=date("d-m-Y");
 if(isset($btn))
 {
 $mq=mysqli_query($connect,"select max(id) from ph_doctor_register");
	 $mr=mysqli_fetch_array($mq);
	 $id=$mr['max(id)']+1;
	 		
	 $ins=mysqli_query($connect,"insert into ph_doctor_register(id,name,email,mobile,address,specialization,uname,pass,rdate) values($id,'$name','$email','$mobile','$address','$city','$uname','$pass','$rdate')");
               ...
               <div class="row">
                  ...
                  <div class="wow fadeInUp" data-wow-delay="0.8s">
						  ...
						  <span id="x52" class="msg"  style="display:none">Mobile no. must be 10 digits!</span>
								   ...
								   <div class="col-md-6 col-sm-6">
                                        <label for="date">Specialization</label>
                                        <input type="text" name="city" value="" class="form-control" placeholder="Your specialization">
										<span id="x8" class="msg"  style="display:none">Enter the Specialization</span>
                                   </div>
								   <div class="col-md-6 col-sm-6">
